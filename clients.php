    ...
    <div class="main--content">
        ...
        <div class="containerpp">
                ...
                <div class="user-info">
                    ...
                    <br />
                    <button class="button" onclick="changeImage()">Ponerse en contacto</button>
                    <button class="button" onclick="changeImage()">Ver historial de pagos</button>
            ...
            <div class="containerpp">
                <div class="image-container" onclick="document.getElementById('myModal').style.display='block'">
                    <img src="images/img.png" alt="Imagen del usuario" class="imagepp" />
                </div>
                <div class="user-info">
                    <span>ID:</span> 123456
                    <br />
            ...
            <div class="containerpp">
                <div class="image-container" onclick="document.getElementById('myModal').style.display='block'">
                    <img src="images/nacho.png" alt="Imagen del usuario" class="imagepp" />
                </div>
                <div class="user-info">
                    <span>ID:</span> 123456
                    <br />
